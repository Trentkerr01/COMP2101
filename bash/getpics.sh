...
#get the file and extract it and then set file permissions so you can view the files.
wget -c https://zonzorp.net/pics.tgz -O - | sudo tar -xz
sudo chmod +rwx pics
sudo mv ./pics ~/public_html/pics
